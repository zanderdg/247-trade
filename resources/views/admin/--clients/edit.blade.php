        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"> <i class="livicon" data-name="members" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
                        Editing Client : {!! $user->first_name!!} {!! $user->last_name!!}
                    </h3>
                            ...
                            <form class="form-wizard form-horizontal" action="" method="POST" id="wizard-validation" enctype="multipart/form-data">
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="family_name" name="family_name" type="text" placeholder="Last Name" class="form-control required" value="{!! Input::old('family_name', $user->family_name) !!}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="phone" name="phone" placeholder="Phone #" type="text" class="form-control required" value="{!! Input::old('phone', $user->client->phone) !!}" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="address" class="col-sm-2 control-label">Address *</label>
                                        <div class="col-sm-10">
                                            <input id="address" name="address" placeholder="Address #" type="text" class="form-control required" value="{!! Input::old('address', $user->client->address) !!}" />
                                        </div>
                                    </div>
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="dob" name="dob" placeholder="DOB" type="text" class="showcal form-control required" value="{!! Input::old('dob', $user->client->dob) !!}" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="tfn_number" class="col-sm-2 control-label">TFN Number *</label>
                                        <div class="col-sm-10">
                                            <input id="tfn_number" name="tfn_number" placeholder="TFN Number" type="text" class="form-control required" value="{!! Input::old('tfn_number', $user->client->tfn_number) !!}" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="abn_number" class="col-sm-2 control-label">ABN Number *</label>
                                        <div class="col-sm-10">
                                            <input id="abn_number" name="abn_number" placeholder="ABN Number" type="text" class="form-control required" value="{!! Input::old('abn_number', $user->client->abn_number) !!}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" title="Select Gender..." name="gender">
                                                ...
                                                <option value="male" @if($user->client->gender === 'male') selected="selected" @endif >MALE</option>
                                                <option value="female" @if($user->client->gender === 'female') selected="selected" @endif >FEMALE</option>
                                                <!-- <option value="other" @if($user->client->gender === 'other') selected="selected" @endif >OTHER</option> -->
