            ...
            <div class="row">
              ...
              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 bhoechie-tab-container" style="height:550px;margin-top: 100px;">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-menu" style="padding:20px;">
                    <div class="list-group">
                      ...
                      <a href="javascript:void(0);step-4" class="list-group-item active text-center">
              ...
              <div class="col-lg-8 col-md-8 offset-md-0">
                  <div class="form-wizard">
                      ...
                      <form action="payment-step" method="post" role="form" id="st1">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">

                          <fieldset class="wizard-fieldset show">
                              <h5>Discounted Fees</h5>
                              <label for="sel1">Hurray,,, Your Are Almost There,</label>
                              <br>
                              <label for="sel1">Last Step and you can Download Your Reports</label>
                              <h5>Your BAS Fees</h5>
                              <div class="form-group">
                                  @if(null !== (request()->session()->get('substype_fees')))
                                      <?php $substype_fees = request()->session()->get('substype_fees'); ?>
                                  @endif
                                  <input type="text" value="{{$substype_fees}}" class="form-control wizard-required" readonly id="substype_fees" name="substype_fees">
                              </div>


                              <h5>DISCOUNT</h5>
                              
                              @if(null !== (request()->session()->get('substype')) &&
                              request()->session()->get('substype') == 1)
                                  <?php $substype_fees = request()->session()->get('substype_fees');
                                        $discount_fees = 4;
                                        $total_fn_fees = $substype_fees - 4;
                                  ?>
                              @elseif(null !== (request()->session()->get('substype')) &&
                              request()->session()->get('substype') == 2)
                                  <?php $substype_fees = request()->session()->get('substype_fees'); 
                                        $discount_fees = 20;
                                        $total_fn_fees = $substype_fees - 20;
                                  ?>
                              @elseif(null !== (request()->session()->get('substype')) &&
                              request()->session()->get('substype') == 3)
                                  <?php $substype_fees = request()->session()->get('substype_fees'); 
                                        $discount_fees = 25;
                              ...
                              @endif
                              <div class="form-group">
                                <input type="text" value="{{$discount_fees}}" class="form-control wizard-required" readonly id="discount_fees" name="discount_fees">
                                
                              </div>

                              
                              <h5>Your Discounted Fees</h5>
                              <div class="form-group">
                                
                                <input type="text" value="{{$total_fn_fees}}" class="form-control wizard-required" readonly id="total_fn_fees" name="total_fn_fees">
                              </div>
