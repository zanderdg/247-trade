...
@section('title')
@lang('email_templates/title.edit')
@parent
@stop
...
<section class="content-header">
    <!--section starts-->
    <h1>@lang('email_templates/title.edit')</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li><a href="{{ route('email_templates') }}">Email Template's</a></li>
        <li class="active">@lang('email_templates/title.edit')</li>
    </ol>
</section>
<!--section ends-->
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            {!! Form::model($email_template, array('url' => URL::to('admin/email_template') . '/' . $email_template->id.'/edit', 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                 <div class="row">
                    <div class="col-sm-8">
