...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('faq/title.edit')</li>
    </ol>
</section>
<!--section ends-->
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            ...
            {!! Form::model($faq, array('url' => URL::to('admin/faq') . '/' . $faq->id.'/edit', 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                 <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class='box-body pad'>
                            {!! Form::label('content', 'Faq Content') !!}
