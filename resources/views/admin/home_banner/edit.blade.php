...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('home_banner/title.edit')</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    {!! Form::model($home_banner, array('url' => URL::to('admin/home_banner') . '/' . $home_banner->id.'/edit', 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                    ...
                    <div class="form-group {{ $errors->first('url', 'has-error') }}">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text('url', $home_banner->url, array('class' => 'form-control', 'placeholder'=>'Banner link url')) !!}
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group {{ $errors->first('order', 'has-error') }}">
                        ...
                        <div class="col-sm-1">
                            {!! Form::text('order', $home_banner->order, array('class' => 'form-control')) !!}
                        </div>
                        <div class="col-sm-4">
