...
<section class="content-header">
    <!--section starts-->
    <h1>@lang('location/title.edit')</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">@lang('location/title.edit')</li>
    </ol>
</section>
<!--section ends-->
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            {!! Form::model($location, array('url' => URL::to('admin/location') . '/' . $location->id.'/edit', 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                 <div class="row">
                    <div class="col-sm-8">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('professional',$professionalList ,null, array('class' => 'form-control', 'placeholder'=>'Select Professional'))!!}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                @if ($location->image)
                                    <div class="form-group">
                                        <img src="{{ Thumb::url('/uploads/source/'.$location->image,300,0) }}" />
                                    </div>
                                @endif
                            </div>
                        </div>
