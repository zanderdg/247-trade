                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="{{ route('signin') }}" autocomplete="on" method="post" role="form">
                                <h3 class="black_bg1"> 24/7Tradespeople Admin</h3>
                                    <!-- CSRF Token -->
                            ...
                            <p class="login button">
                                <a href="{{ route('index') }}" class="btn btn-success btn-block admin-site-btn">Visit Site</a>
                            </p>
                        </div>
                        <div id="register" class="animate form">
                            <form action="{{ route('signup') }}" autocomplete="on" method="post" role="form">
                                <h3 class="black_bg">Sign Up</h3>
                                    <!-- CSRF Token -->
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
