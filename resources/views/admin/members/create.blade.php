                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-wizard form-horizontal" action="{{ route('create/member') }}" method="POST" id="wizard-validation" enctype="multipart/form-data">
                                <!-- CSRF Token -->
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        <label for="activate" class="col-sm-2 control-label"> Activate Member</label>
                                        <div class="col-sm-10">
