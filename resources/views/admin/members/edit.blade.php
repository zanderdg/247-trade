            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"> <i class="livicon" data-name="members" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
                        Editing Customer : {!! $user->first_name!!} {!! $user->last_name!!}
                    </h3>
                            ...
                            <form class="form-wizard form-horizontal" action="" method="POST" id="wizard-validation" enctype="multipart/form-data">
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="phone" name="phone" placeholder="Phone #" type="text" class="form-control required" value="{!! Input::old('phone', $user->members->phone) !!}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" title="Select Gender..." name="gender">
                                                ...
                                                <option value="male" @if($user->members->gender === 'male') selected="selected" @endif >MALE</option>
                                                <option value="female" @if($user->members->gender === 'female') selected="selected" @endif >FEMALE</option>
                                                <!-- <option value="other" @if($user->members->gender === 'other') selected="selected" @endif >OTHER</option> -->
