...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('menu_link/title.edit')</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    {!! Form::model($menu_link, array('url' => URL::to('admin/menu_link') . '/' . $menu_link->id.'/edit', 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::select('parent_id',$parent_menus , $menu_link->parent_id, array('class' => 'form-control select2', 'placeholder'=>'Select Parent Menu'))!!}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text('other_url', $menu_link->other_url, array('class' => 'form-control', 'placeholder'=>'Menu Other Url')) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group {{ $errors->first('order', 'has-error') }}">
                        ...
                        <div class="col-sm-1">
                            {!! Form::text('order', $menu_link->order, array('class' => 'form-control')) !!}
                        </div>
                        <div class="col-sm-4">
