...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('page/title.create')</li>
    </ol>
</section>
...
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            ...
            {!! Form::open(array('url' => URL::to('admin/page/create'), 'method' => 'post', 'class' => 'bf', 'id'=>'page_form', 'files'=> true)) !!}
                 <div class="row">
                    <div class="col-sm-8">
                        <div class="form-group">
                            {!! Form::label('title', 'Page Title') !!}
                            {!! Form::text('title', null, array('class' => 'form-control input-md', 'required' => 'required', 'placeholder'=>'Page title here... (Eg: Home Page)'))!!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        {!! Form::text('image', null, array('class' => 'form-control', 'placeholder'=>'Select page image', 'id' => 'image')) !!}
                                        <span class="input-group-btn">
                        ...
                        <div class="panel panel-primary golf">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('banner_button_url', '#', array('class' => 'form-control', 'placeholder'=>'Banner Button Link')) !!}
                                </div>                                
                            </div>
                        </div>
                        <div class="panel panel-primary golf">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="checkbox" value="1" name="is_show"/>&nbsp;Show Widget?
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('widget_button_url', '#', array('class' => 'form-control', 'placeholder'=>'Button Link')) !!}
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-primary golf">
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        $("#page_preview").on("click", function(e){
            ...
            $from.submit();
            $from.attr('action','{!! URL::to("admin/page/create") !!}');
