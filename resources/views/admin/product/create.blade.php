...
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            ...
            {!! Form::open(array('url' => URL::to('admin/product/create'), 'method' => 'post', 'class' => 'bf', 'id'=>'page_form', 'files'=> true)) !!}
                 <div class="row">
                    <div class="col-sm-8">
                        <div class="form-group {{ $errors->first('ProductName', 'has-error') }}">
                                    ...
                                    <table class="table table-bordered table-order" id="table1">                       
                                        <tbody>                                            
                                            ...
                                            @endif    
                                                <td class="sorting_1">
                                                    <div class="checkbox">
                                                      <label><input name="productcats[]" type="checkbox" value="{{$cats->id}}">{{$cats->title}}</label>
                                                    </div>
                                                </td>
                                                @if($s > 1 && $s %1==0)
                                            <!-- </tr> -->
                                    ...
                                    <table class="table table-bordered table-order" id="table1">                       
                                        <tbody>                                            
                                            ...
                                            @endif    
                                                <td class="sorting_1">
                                                    <div class="checkbox">
                                                      <label><input name="productbrands[]" type="checkbox" value="{{$br->id}}">{{$br->title}}</label>
                                                    </div>
                                                </td>
                                                @if($s > 1 && $s %1==0)
                                            <!-- </tr> -->
