...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('productbrand/title.edit')</li>
    </ol>
</section>
            ...
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    <div class="col-sm-8">
                        ...
                        {!! Form::model($Productbrand, array('url' => URL::to('admin/productbrand') . '/' . $Productbrand->id.'/edit', 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
