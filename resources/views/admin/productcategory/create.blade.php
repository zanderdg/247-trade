...
@section('title')
    @lang('productcategory/title.create') :: @parent
@stop
...
<section class="content-header">
    <h1>
        @lang('productcategory/title.create')
    </h1>
    <ol class="breadcrumb">
        <li>
            ...
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    <div class="col-sm-8">
                        ...
                        {!! Form::open(array('url' => URL::to('admin/productcategory/create'), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
