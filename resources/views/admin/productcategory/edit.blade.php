...
{{-- Web site Title --}}
@section('title')
@lang('productcategory/title.edit')
@parent
@stop
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('productcategory/title.edit')</li>
    </ol>
</section>
            ...
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    <div class="col-sm-8">
                        ...
                        {!! Form::model($Productcategory, array('url' => URL::to('admin/productcategory') . '/' . $Productcategory->id.'/edit', 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                        <div class="form-group {{ $errors->first('title', 'has-error') }}">
                            <label for="title" class="col-sm-4 control-label1">
                                @lang('productcategory/form.name')
                            </label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group {{ $errors->first('status', 'has-error') }}">
                            <label for="status" class="col-sm-4 control-label1">
                                @lang('productcategory/form.status')
                            </label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-0 col-sm-4">
                                <a class="btn btn-danger" href="{{ route('productcategory') }}">
                                    @lang('button.cancel')
                                </a>
