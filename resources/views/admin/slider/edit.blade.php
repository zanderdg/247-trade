...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('slider/title.edit')</li>
    </ol>
</section>
<!--section ends-->
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            ...
            {!! Form::model($slider, array('url' => URL::to('admin/slider') . '/' . $slider->id.'/edit', 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                 <div class="row">
                    <div class="col-sm-8">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="input-group demo3">
                                {!! Form::text('slider_button_text_color', '#333', array('class' => 'form-control', 'readonly' => 'readonly'))!!}
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                @if ($slider->slider_image)
                                    <div class="form-group">
                                        {!! HTML::image('/uploads/source/'.$slider->slider_image, '', array('style' => 'max-width:300px')) !!}
                                    </div>
                                @endif
                            </div>
                        </div>
