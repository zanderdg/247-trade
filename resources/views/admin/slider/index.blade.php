...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('slider/title.management')</h1>
        <ol class="breadcrumb">
            <li>
        ...
        <div class="row">
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <a href="{{ URL::to('admin/slider/create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
                    </div>
                </div>
                <br />
