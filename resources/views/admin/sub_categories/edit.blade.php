            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" action="{{ route('update/subcategory', $sub_category->id) }}" method="POST">
                            <!-- CSRF Token -->
                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />

                            <section>
                                <div class="form-group">
                                    <label for="parentCategory" class="col-sm-2 control-label">Associate Category *</label>
                                    <div class="col-sm-10">
                                        <select id="parentCategory" name="category_id" class="form-control required">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="first_name" name="name" value="{{ Input::old('name', $sub_category->name) }}" type="text" placeholder="Category Name" class="form-control required"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="first_name" class="col-sm-2 control-label">Description</label>
                                    <div class="col-sm-10">
                                        <textarea name="description" type="text" class="textarea form-control required" rows="6">{{ Input::old('description', $sub_category->description) }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="first_name" class="col-sm-2 control-label"> Want to publish? </label>
                                    <div class="col-sm-10">
                                        <input type="checkbox" name="status" @if($sub_category->status) checked @endif> 
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('subcategory') }}" type="botton" class="btn btn-link">back</a>
                        </form>
