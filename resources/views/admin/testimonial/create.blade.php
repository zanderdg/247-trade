...
<section class="content-header">
    <!--section starts-->
    <h1>@lang('testimonial/title.create')</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">@lang('testimonial/title.create')</li>
    </ol>
</section>
<!--section ends-->
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            ...
            {!! Form::open(array('url' => URL::to('admin/testimonial/create'), 'method' => 'post', 'class' => 'bf', 'files'=> true)) !!}
                 <div class="row">
                    <div class="col-sm-8">
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="checkbox" value="1" name="is_home"/>&nbsp;Show On Home ?
                                    </div>
                                </div>
                            </div>
                        </div>
