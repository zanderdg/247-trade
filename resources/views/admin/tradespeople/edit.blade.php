            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" action="{{ route('update/category', $category->id) }}" method="POST"  enctype="multipart/form-data"s>
                            <!-- CSRF Token -->
                            ...
                            <section>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="first_name" name="name" value="{{ Input::old('name', $category->name) }}" type="text" placeholder="Category Name" class="form-control required"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="cat_icon" class="col-sm-2 control-label">Category Icon</label>
                                    <div class="col-sm-10">
                                        <input type="file" id="cat_icon" value="{{ Input::old('cat_icon', $category->icon) }}" name="cat_icon" class="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="first_name" class="col-sm-2 control-label">Description</label>
                                    <div class="col-sm-10">
                                        <textarea name="description" type="text" class="textarea form-control required" rows="6">{{ Input::old('description', $category->description) }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="first_name" class="col-sm-2 control-label"> Want to publish? </label>
                                    <div class="col-sm-10">
                                        <input type="checkbox" name="status" @if($category->status) checked @endif> 
                                    </div>
                                </div>
