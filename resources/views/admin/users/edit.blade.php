                            ...
                            <form class="form-wizard form-horizontal" action="" method="POST" id="wizard-validation" enctype="multipart/form-data">
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="phone" name="phone" placeholder="Phone #" type="text" class="form-control required" value="{!! Input::old('phone', $user->userDetails->phone) !!}" />
                                        </div>
                                    </div>
                               ...
                               <h1>Bio</h1>
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="dob" name="dob" type="text" class="form-control" data-mask="9999-99-99" value="{!! Input::old('dob', $user->userDetails->dob) !!}" placeholder="yyyy-mm-dd" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;">
                                                    @if($user->userDetails->picture)
                                                        <img src="{!! url('/').'/uploads/users/'.$user->userDetails->picture !!}" alt="profile pic">
                                                    @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="bio" id="bio" class="form-control" rows="4">{!! Input::old('bio', $user->userDetails->bio) !!}</textarea>
                                        </div>
                                    </div>
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" title="Select Gender..." name="gender">
                                                ...
                                                <option value="male" @if($user->userDetails->gender === 'male') selected="selected" @endif >MALE</option>
                                                <option value="female" @if($user->userDetails->gender === 'female') selected="selected" @endif >FEMALE</option>
                                                <option value="other" @if($user->userDetails->gender === 'other') selected="selected" @endif >OTHER</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::select('country', $countries,Input::old('country',$user->userDetails->country),array('class' => 'form-control')) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="state" name="state" type="text" class="form-control" value="{!! Input::old('state', $user->userDetails->state) !!}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="city" name="city" type="text" class="form-control" value="{!! Input::old('city', $user->userDetails->city) !!}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="address" name="address" type="text" class="form-control" value="{!! Input::old('address', $user->userDetails->address) !!}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="postal" name="postal" type="text" class="form-control" value="{!! Input::old('postal', $user->userDetails->postal) !!}" />
                                        </div>
                                    </div>
                                ...
                                <section>
                                    ...
                                    <div class="form-group">
                                        <label for="activate" class="col-sm-2 control-label"> Activate Agent</label>
                                        <div class="col-sm-10">
                                            <input id="activate" name="activate" type="checkbox" class="pos-rel p-l-30" value="1" @if($status) checked="checked" @endif  >
                                        </div>
                                        <span>If Agent is not activated, mail will be sent to Agent with activation link</span>
                                    </div>
