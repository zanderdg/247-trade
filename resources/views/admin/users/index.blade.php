                        	...
                        	<tr>
                				...
                				<td>
                                    ...
                                    {{-- @if ((Sentinel::getUser()->id != $user->id) && ($user->id != 1))
                                        @if (Sentinel::getUser()->hasAccess(['confirm-delete/user']))
                                            
                                        @endif
                                        @if (Sentinel::getUser()->hasAccess(['confirm-disable/user']))
                                            <a href="{{ route('confirm-disable/user', $user->id) }}" data-toggle="modal" data-target="#disable_confirm"><i class="livicon" data-name="warning-alt" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="disable user"></i></a>
                                        @endif    
                    				@endif   --}}                           
                                </td>
                			</tr>
