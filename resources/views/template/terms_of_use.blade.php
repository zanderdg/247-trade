    ...
    <div class="container py-5">
        ...
        <div class="define">
            ...
            <p class="m-0">
                ...
                The “Service” consists of the website currently located at <a href="{{ url('/') }}">www.247tradespeople.com</a>, our Apps, any pages we operate on third party social media applications, and the content and services we make available through them via the internet, mobile devices including smart phones and tablets, and/or interactive television devices and services.
                </p>

            <h2 class="pt-4 pb-0">Service Content</h2>
            <p class="m-0">
...
The ratings and other information found on the Service are provided by users, not by us. We do not endorse or recommend any particular third party service. Any material you obtain from the Service is used at your own risk, and we will not be liable for any loss or damage arising out of or in connection with access or use of the Service (except to the extent that such liability cannot be excluded by law).
            ...
            <h2 class="pt-4 pb-0">Links and User Content</h2>
            <p class="m-0">It is not possible for us to review all websites which are linked from the Service (or link to the Service), and you should therefore take care when following any link. We cannot accept liability for any loss or damage that may be suffered as a result of following any links.
...
It is important for you to note that all Communities are public, and that others may read communications made via the Community without the author’s knowledge. Always use caution when giving out any personally identifying information about yourself in any Community, and do not give personally identifying information about any other person unless entitled to do so.
        ...
        <h2 class="pt-4 pb-0">Use of Information</h2>
        <p class="m-0">You agree not to copy, reproduce, modify, create derivative works from, distribute or publicly display any content (except for your own information) from the Service without our prior written permission.
...
Solely for the purposes of receiving the Service, we hereby grant to you for the period during which the Service is provided a non-exclusive, non-transferable, licence to use the Rights.
        ...
        <h2 class="pt-4 pb-0">Limitation of Liability</h2>
        <p class="m-0">Notwithstanding any other provision, nothing in these Terms of Use shall exclude or limit either party’s liability for death or personal injury caused by that party’s negligence, fraud or fraudulent misrepresentation, or any other liability that cannot lawfully be excluded or limited.
...
In the event that any limitation or exclusion of liability in these Terms of Use proves ineffective, then we shall not be liable to you for more than £100 in aggregate. If you register on the website or any Apps, then only the aggregate cap on liability under the agreement which you enter into upon registration shall apply. If you register as both a “Homeowner” and as a “Trade Business” then only the aggregate cap in the Trade Business User Agreement shall apply.
...
Each of the provisions of this Clause shall be construed separately and independently of the others.
        ...
        <h2 class="pt-4 pb-0">Our Rights</h2>
        <p class="m-0">We reserve the right at all times to edit, refuse to post, or to remove from the Service any information or materials for any reason whatsoever, and to disclose any information we deem appropriate to satisfy any applicable law, regulation, legal process, police request or governmental request.
